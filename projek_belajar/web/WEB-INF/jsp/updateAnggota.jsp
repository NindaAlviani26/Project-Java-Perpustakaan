<%-- 
    Document   : updateAnggota
    Created on : Oct 5, 2019, 11:14:27 AM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <div id="kotak">
            ...
            <form:form id="formInput" action="SimpanUpdate.htm" modelAttribute="dto" method="POST">
                <h1 align="center" id="tulis">Update Data</h1> 
                <div id="s">
                </div>
                <table align="center">
                    <tr><td><h4><form:label  id="tulis"  path="no">Id</form:label></h4></td><td>:</td><td><form:input readonly="true" path="no" placeholder="Masukkan No" class="form-control"></form:input></td></tr>
